...
import com.sampledemo.project.pagefactory.pageobjects.registerPage;
import com.sampledemo.project.pagefactory.pageobjects.signOnPage;

public class registerPageTestcase extends setupClass{
	...
	public static Object[][] data() {
		...
		String Filename = System.getProperty("user.dir") + "/utility/testdata.xlsx";
	...
	public void registration(Map<Object, Object> mp) {
		test = extent.createTest("Register with username and password for the testdata "+ (String)mp.get("SNO"));
		PageFactory.initElements(driver, homePage.class);
		homePage.registerlink.click();
		PageFactory.initElements(driver, registerPage.class);
		registerPage.Username.sendKeys((String) mp.get("username"));
		registerPage.password.sendKeys((String) mp.get("password"));
		registerPage.confirmPassword.sendKeys((String) mp.get("confirmpassword"));
